...
export default function Form() {
    ...
    const onChangeInputZGenerator = function(e){
    ...
    return (
        <form id="joinForm" name="joinForm" method="post" action="/do/not/post">
            ...
            <fieldset>
                ...
                defaultChecked={ true } checked={gender==='female'}
                onChange={onChangeInputZGenerator}/>

                <label>남</label> 
                <input type="radio" name="gender" value={ "male" } 
                defaultChecked={ false } checked={gender==='male'}
                onChange={onChangeInputZGenerator}/>
            </fieldset>
            ...
            <fieldset>
                <legend>약관동의</legend>
                <input id="agree-prov" type="checkbox" name="agreeProv" value= {agreeProv} 
                defaultChecked={ false } checked={agreeProv==='yes'}
