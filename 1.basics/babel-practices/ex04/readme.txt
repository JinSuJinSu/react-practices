...
3. Env Preset은 stage 3레벨 이상의 문법들을 플러그인
4. Env Preset뿐만 아니라 다양한 플러그인들은 babel 설정을 통해서 적용할 수 있다.(babel.config)
...
브라우저별 es6 호환성 테이블(kang/githubio/component-table/es6)
